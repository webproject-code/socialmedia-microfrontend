import { Box, Card, Divider, Skeleton } from '@social-media/evoke-ui';

export const ChatListSkeleton = () => {
  return (
    <Box className="flex flex-grow flex-col h-full w-full px-2 gap-y-1 overflow-hidden">
