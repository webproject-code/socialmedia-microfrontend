...
export const CreateChatModal: React.FC<CreateChatModalProps> = ({
  ...
  return (
    <Portal>
      <div className="fixed inset-0 ok z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
        <div
          className="bg-white dark:bg-gray-900 rounded-sm shadow-xl max-w-xl w-full mx-auto"
          role="dialog"
          aria-modal="true"
        ...
        >
          <div className="border-b border-gray-200 dark:border-gray-800 p-4">
            <div className="flex items-center justify-between">
              <h2
                id="modal-title"
                className="text-xl font-semibold text-light-secondary dark:text-dark-lavender"
              >
                {groupChat ? 'Create Group Chat' : 'New Chat'}
              </h2>
              <button
